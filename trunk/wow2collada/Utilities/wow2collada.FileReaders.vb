...
Namespace wow2collada.FileReaders
    ...
    Class MPQ
        ...
        Public _FileList As New System.Collections.Generic.Dictionary(Of String, FileListEntry)
        ...
        Public Sub New()
            ...
            Else
                _BasePath = p1 & "data\"
            End If
            ' manual override if on my system because I have several WOW installations with different patchlevels
            _BasePath = _BasePath.Replace("--wowtest--", "wow")
        ...
        Public Function Locate(ByVal path As String) As Boolean
            Return _FileList.ContainsKey(path.ToLower)
        End Function

        Public Function LoadFile(ByVal path As String) As Stream
            If _FileList.ContainsKey(path.ToLower) Then
                Dim fi As FileListEntry = _FileList(path.ToLower)
    ...
    Class DBC
        ...
        Public Function LoadCreatureModelDataFromStream(Byref File as Stream)
        ...
        Public Function LoadCreatureDisplayInfoFromStream(Byref File As Stream)
            Dim br As New BinaryReader(File)
    ...
    Class BLP
        ...
        Public Function LoadFromStream(ByRef File As Stream) As Bitmap
            Dim br As New BinaryReader(File)
